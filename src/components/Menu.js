              ...
              <li>
                <div>
                  <Button variant="outline-info" id="heads"
                    onClick={this.gotoAddPatient} inverted="true">
                ...
                <div>
                  <Link to="/">
                    <Button variant="outline-info"id="heads1"
                      onClick={this.onClick} inverted="true">
          ...
          <div className="content-section implementation">
            ...
            >
              ...
              <div className="p-grid">
                <div className="p-col">
                  <Button variant="outline-success" className="block height"
                     onClick={this.dialogAlert} inverted="true">
                      <Icon name='edit' /> Edit or Show Medical Records
                    </Button>
                </div>
                <div className="p-col">
                  <Button variant="outline-danger" className="block height"
                    onClick={this.handleDelete} inverted="true">
